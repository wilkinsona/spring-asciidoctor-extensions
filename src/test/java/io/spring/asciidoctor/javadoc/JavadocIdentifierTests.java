...
public class JavadocIdentifierTests {
	...
	public void methodOnUnqualifiedClass() {
		...
		assertThat(identifier.getPackageName()).isNull();
		assertThat(identifier.getClassName()).isEqualTo("FooBarBaz");
		assertThat(identifier.getMethod()).isNotNull();
		assertThat(identifier.getMethod().getName()).isEqualTo("someMethod");
	}
	...
	public void methodWithOneParameter() {
		...
		assertThat(identifier.getMethod()).isNotNull();
		assertThat(identifier.getMethod().getName()).isEqualTo("someMethod");
		assertThat(identifier.getMethod().getParameters()).containsExactly("String");
	}
	...
	public void methodWithMultipleParameters() {
		...
		assertThat(identifier.getMethod()).isNotNull();
		assertThat(identifier.getMethod().getName()).isEqualTo("someMethod");
		assertThat(identifier.getMethod().getParameters()).containsExactly("String", "Object");
	}
